...
namespace StudentAssistant.WebUI.Controllers
{
    ...
    {
        [HttpGet]
        public async Task<IActionResult> MatematikMessage()
        {
            ...
            var defaultText = $"Merhaba ben {studentInfo.Name} {studentInfo.Surname}.{studentInfo.Department} {studentInfo.Class}. sınıf öğrencisiyim.Matematik dersim ile ilgili sana soru soracağım.";
                ...
                Headers =
    {
        ...
        [HttpPost]
        public async Task<IActionResult> MatematikMessage(MessageViewModel requestMessageViewModel)
        {
            var client = new HttpClient();
            var request = new HttpRequestMessage
            {
